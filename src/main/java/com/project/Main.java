...
public class Main {
    public static void main(String[] args) {
        ...
        Employe emp1 = new Employe(1, "AAAA", "aaaa", "Informatique", 3);
        Employe emp2 = new Employe(2, "BBBB", "bbbb", "Ressources Humaines", 2);
        Employe emp3 = new Employe(3, "CCCC", "cccc", "Informatique", 4);
